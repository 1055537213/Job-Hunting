...
assert.match(template, /demo_recharge_max_amount_yuan/);
assert.match(template, /demo_recharge_max_total_yuan/);
assert.match(template, /profileCenter\.settings\?\.demo_recharge_enabled === false/);
