...
当前最新 revision 为 `20260828_0019`。初始 revision 为 `20260807_0001`，其中包含：
...
- `20260828_0019` 为 `rag_chunks.content` 增加 PostgreSQL `pg_trgm` 索引，供图号、尺寸、公差等
  含数字术语的精确补召回使用；它仍受账号、候选人和 Embedding 模型过滤，不改变向量索引的语义空间。
